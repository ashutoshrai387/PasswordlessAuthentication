...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 29cafeef-f67a-48e0-b208-7513d554f534
```

> `29cafeef-f67a-48e0-b208-7513d554f534` is the password of the certificate, you can change it to any password you want.
